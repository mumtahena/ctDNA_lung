...
```{r Supplemental.Figure.2,echo=FALSE,cache=TRUE,warning=FALSE}
##Supplemental Figure 2(A)
###histogram of reported VAFs
supp_2a<-ggplot(prep_gg,aes(x=ctDNA))+geom_histogram(color="brown3", fill="brown3")+
...
supp_2b<-ggplot(nccn_gg, aes(x=Gene, y=ctDNA)) + 
...
#png("Supplemental Figure 2",width = 6,height = 8,units = "in",res=1024)
ggarrange(supp_2a,supp_2b,nrow=2,labels = c("A","B"))
#dev.off()
